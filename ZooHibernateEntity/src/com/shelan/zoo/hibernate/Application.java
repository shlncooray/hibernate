...
public class Application {
	...
	static void saveData(){
		...
		animal.addCageAllocation(new CageAllocation(new Date(), new Date(), "Cage Maintance 1"));
		session.save(animal);
		...
		animal1.addCageAllocation(new CageAllocation(new Date(), new Date(), "New Open Area 1"));
	...
	static void lodaData(){
		...
		animal.addCageAllocation(new CageAllocation(new Date(), new Date(), "Relocated to Previous 1"));
